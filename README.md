...
```
node scripts/build.cjs v0.4
node scripts/check.cjs v0.4
node scripts/browser-test.cjs v0.4
node scripts/rail-motion-test.cjs v0.4
node scripts/rail-visual-motion.cjs v0.4
node scripts/rail-preservation.cjs v0.4 v0.3
node scripts/shell-regression.cjs
node scripts/compare.cjs v0.3 v0.4
# Inspect evidence; write the matching visual-review.json only after review.
node scripts/release.cjs v0.4
```
